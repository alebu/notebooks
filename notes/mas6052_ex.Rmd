...
By the definition of standard Brownian motion, we have 
...
\mathbb{E}[B_t^2 - 2B_tB_u + B_u^2 | \mathcal{F}_u] = 
$$
By linearity of conditional expectation:

$$
= \mathbb{E}[B_t^2| \mathcal{F}_u] - 2\mathbb{E}[B_tB_u| \mathcal{F}_u] + \mathbb{E}[B_u^2| \mathcal{F}_u] = 
$$
By measurability and taking out what is known:

$$
= \mathbb{E}[B_t^2| \mathcal{F}_u] - B_u\mathbb{E}[B_t| \mathcal{F}_u] + B_u^2 = 
$$
